...
Complete documentation with detailed explanations and advanced configurations.
> **⚠️ Before you begin:**
...
There are extra steps here since the plugin is not yet officially released:

1. Clone the [Livekit Agents repository](https://github.com/livekit/agents) to your machine.
2. Navigate to `agents/livekit-plugins/livekit-plugins-hedra`.
