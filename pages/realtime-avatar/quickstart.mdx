...
1. **Clone the [Create Hedra Avatar](https://github.com/surya-duggirala-hedra/create-hedra-avatar) repository.**

2. **Navigate to the project directory:**

```sh
cd create-hedra-avatar
```

3. **Create your application (replace &lt;app-name&gt; with your desired name):**

```sh
npx create-hedra-avatar-test <app-name>
```
...
5. **Create `.env.local` in both frontend and backend directories and copy the contents of the `.env` file created earlier:**
...
7. **Start the application (in a new terminal):**
