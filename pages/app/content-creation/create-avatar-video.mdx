...
# Create an Avatar Video from an Image

Learn how to turn a static image into a speaking avatar video using Hedra Studio.
...
1. Open **Hedra Studio**
2. Upload an image **or** generate one using an image model
...
- Record directly in Hedra
- Generate AI voice using supported voice models

1. Navigate to the **Audio** section
...
1. Go to the **Video Generation** section
2. Choose an avatar-compatible video model
