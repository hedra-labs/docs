...
Credits are billed on a flat rate per 1,000 characters. You'll see a character counter underneath the text box so you can always keep an eye on character count. There is no proration of the character count to credits, so if you have 1,001 characters or 1,999 characters, you'd be charged 30 credits.
