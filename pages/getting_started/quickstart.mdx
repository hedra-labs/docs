...
<CardGroup cols={2}>
  <Card title="Generate an Image" icon="image" href="/pages/guides/generate-image">
    Generate images from text prompts using models like Sana and Flux.
  </Card>
  <Card title="Generate a Video" icon="video" href="/pages/guides/generate-video">
    Create videos from images and text prompts using partner video models.
  </Card>
  <Card title="Generate an Avatar Video" icon="user" href="/pages/guides/generate-avatar-video">
    Create talking-head and motion avatar videos with Hedra Avatar and Omnia.
  </Card>
  <Card title="Generate Audio" icon="microphone" href="/pages/guides/generate-audio">
