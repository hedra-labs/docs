...
description: "Get started with the Hedra API: use a paid account, register an API key from the developer console, and make your first image, video, or audio call."
---
