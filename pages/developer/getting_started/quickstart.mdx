...
<Note>
  The Hedra v3 API is now available. This guide covers the legacy API and is maintained for existing integrations. For new projects, [get started with the Developer Platform →](/pages/developer/v3/quickstart)
</Note>
