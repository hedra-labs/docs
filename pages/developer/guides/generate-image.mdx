...
description: "Generate images from text prompts with the Hedra API by POSTing to the public /generations endpoint with your X-API-Key and an image request payload."
---
