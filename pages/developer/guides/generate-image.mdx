---
title: "Generate an Image (Legacy API)"
sidebarTitle: "Generate an Image"
description: "Generate images from text prompts with the legacy Hedra API by POSTing to the public /generations endpoint with your X-API-Key and an image request payload."
---
