---
title: "Generate Audio (Legacy API)"
sidebarTitle: "Generate Audio"
description: "Convert text to speech with the legacy Hedra API: list voices, submit a generation to the public endpoint with your X-API-Key, and retrieve the audio output."
---
