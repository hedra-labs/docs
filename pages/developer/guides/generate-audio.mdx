...
description: "Convert text to speech with the Hedra API: list voices, submit a generation to the public endpoint with your X-API-Key, and retrieve the audio output."
---
