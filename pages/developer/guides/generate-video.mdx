---
title: "Generate a Video (Legacy API)"
sidebarTitle: "Generate a Video"
description: "Generate videos from text or image prompts with the legacy Hedra API, including text-to-video with Grok Video T2V and image-to-video model workflows."
---
