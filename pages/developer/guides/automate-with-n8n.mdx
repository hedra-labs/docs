---
title: "Automate Content with n8n (Legacy API)"
sidebarTitle: "Automate Content with n8n"
description: "Automate content generation with the legacy Hedra API in n8n: set up an X-API-Key credential and drive HTTP Request nodes to schedule and chain generations."
---
