...
description: "Generate lip-synced talking-head avatar videos with the Hedra API by uploading audio and an image and calling the together/hedra-avatar video model."
---
