---
title: "Generate an Avatar Video (Legacy API)"
sidebarTitle: "Generate an Avatar Video"
description: "Generate lip-synced talking-head avatar videos with the legacy Hedra API by uploading audio and an image and calling the together/hedra-avatar video model."
---
