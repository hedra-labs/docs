---
title: "Legacy Hedra API Quickstart"
sidebarTitle: "Quickstart"
description: "Quickstart for the legacy Hedra API. Building something new? Use the Hedra v3 API on the Developer Platform instead."
noindex: true
---

<div id="legacy-quickstart-header">
  <h1>[Legacy] Hedra API Quickstart Guide</h1>
  <p>Getting started with the Hedra API is easy.</p>
</div>

<Note>
  **Note:** The Hedra v3 API is now available. This guide covers the legacy API and is maintained for existing integrations. For new projects, [get started with the Developer Platform →](/pages/developer/v3/quickstart)
</Note>
